...
class DatasetDicts(dict):
    ...
    def dataset_func(dataset, function, **kwargs):
        # Convert 'Dst Port' column to integer type
        dataset['Dst Port'] = dataset['Dst Port'].astype(int)

        # Call the original function with the dataset
        return function(dataset, **kwargs)
