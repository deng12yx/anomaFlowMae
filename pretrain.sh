...
torchrun \
  ...
  --train_dir "/root/autodl-tmp/Flow-MAE/data/FinetunetestData/pretrain4096_0.75train.pkl" \
  --validation_dir "/root/autodl-tmp/Flow-MAE/data/FinetunetestData/pretrain4096_0.75test.pkl" \
