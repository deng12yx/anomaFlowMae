...
torchrun \
  ...
  --train_dir "/root/autodl-tmp/Flow-MAE/data/FineDatatestP_M/pretrain4096_0.75train.pkl" \
  --validation_dir "/root/autodl-tmp/Flow-MAE/data/FineDatatestP_M/pretrain4096_0.75test.pkl" \
